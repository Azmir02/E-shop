  ...
  return (
    <div className="flex items-center justify-between w-full gap-x-5">
        <div className="border border-black100 rounded-[10px] flex items-center justify-between px-[18px] py-[14px] w-[332px]">
             <input placeholder={t('Search Products_...')} type="text" className="outline-none" />
             <CiSearch size={20} />
        </div>
        <div className="flex items-center gap-x-5">
           ...
           <div>
            ...
            <span className="font-montserrat text-base font-bold text-black01">$150,00</span>
           </div>
        </div>
        <div className="w-[1px] h-[32px] bg-black100"></div>
         <div className="flex items-center gap-x-5">
           ...
           <div>
            ...
            <span className="font-montserrat text-base font-bold text-black01">{t("Account")}</span>
           </div>
        </div>
    </div>
  )
