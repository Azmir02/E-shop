...
const handleLanguageChange = (value)=>{
    const findLanguage = countriesOptionsWithFlag.find((language)=>language.value === value)
    if(findLanguage) {
  ...
  return (
    <div className="flex items-center w-full gap-x-5 justify-end">
         ...
         <div className="flex items-center gap-x-4">
            <Link to="facebook.com"><FaFacebookF color="#303030" /></Link>
            <Link  to="facebook.com"><FaTwitter color="#303030" /></Link>
            <Link  to="instagram.com"><LuInstagram color="#303030" /></Link>
         </div>
    </div>
  )
}
